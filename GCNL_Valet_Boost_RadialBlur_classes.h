...
struct AGCNL_Valet_Boost_RadialBlur_C : AFortGameplayCueNotify_Loop {
	...
	float BlendTimeline_BlendWeight_4BA13AB34E6EEF57F3BD4A9FB71B4A52; // 0x7e0(0x04)
	enum class ETimelineDirection BlendTimeline__Direction_4BA13AB34E6EEF57F3BD4A9FB71B4A52; // 0x7e4(0x01)
	char pad_7E5[0x3]; // 0x7e5(0x03)
	struct UTimelineComponent* BlendTimeline; // 0x7e8(0x08)

	void BlendTimeline__FinishedFunc(); // Function GCNL_Valet_Boost_RadialBlur.GCNL_Valet_Boost_RadialBlur_C.BlendTimeline__FinishedFunc // (BlueprintEvent) // @ game+0xda7c34
	void BlendTimeline__UpdateFunc(); // Function GCNL_Valet_Boost_RadialBlur.GCNL_Valet_Boost_RadialBlur_C.BlendTimeline__UpdateFunc // (BlueprintEvent) // @ game+0xda7c34
	...
	void ExecuteUbergraph_GCNL_Valet_Boost_RadialBlur(int32_t EntryPoint); // Function GCNL_Valet_Boost_RadialBlur.GCNL_Valet_Boost_RadialBlur_C.ExecuteUbergraph_GCNL_Valet_Boost_RadialBlur // (Final|UbergraphFunction|HasDefaults) // @ game+0xda7c34
};
