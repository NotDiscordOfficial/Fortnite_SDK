...
struct FBaseAttenuationSettings {
	...
	float ConeSphereRadius; // 0x28(0x04)
	float ConeSphereFalloffDistance; // 0x2c(0x04)
	struct FRuntimeFloatCurve CustomAttenuationCurve; // 0x30(0x88)
};
...
struct FMaterialCachedExpressionData {
	...
	uint32_t MaterialAttributesPropertyConnectedBitmask; // 0x224(0x04)
};
...
// Size: 0x3a8 (Inherited: 0xb8)
struct FSoundAttenuationSettings : FBaseAttenuationSettings {
	char bAttenuate : 1; // 0xb8(0x01)
	char bSpatialize : 1; // 0xb8(0x01)
	char bAttenuateWithLPF : 1; // 0xb8(0x01)
	char bEnableListenerFocus : 1; // 0xb8(0x01)
	char bEnableFocusInterpolation : 1; // 0xb8(0x01)
	char bEnableOcclusion : 1; // 0xb8(0x01)
	char bUseComplexCollisionForOcclusion : 1; // 0xb8(0x01)
	char bEnableReverbSend : 1; // 0xb8(0x01)
	char bEnablePriorityAttenuation : 1; // 0xb9(0x01)
	char bApplyNormalizationToStereoSounds : 1; // 0xb9(0x01)
	char bEnableLogFrequencyScaling : 1; // 0xb9(0x01)
	char bEnableSubmixSends : 1; // 0xb9(0x01)
	char pad_B9_4 : 4; // 0xb9(0x01)
	enum class ESoundSpatializationAlgorithm SpatializationAlgorithm; // 0xba(0x01)
	char pad_BB[0x1]; // 0xbb(0x01)
	float BinauralRadius; // 0xbc(0x04)
	enum class EAirAbsorptionMethod AbsorptionMethod; // 0xc0(0x01)
	enum class ECollisionChannel OcclusionTraceChannel; // 0xc1(0x01)
	enum class EReverbSendMethod ReverbSendMethod; // 0xc2(0x01)
	enum class EPriorityAttenuationMethod PriorityAttenuationMethod; // 0xc3(0x01)
	float OmniRadius; // 0xc4(0x04)
	float StereoSpread; // 0xc8(0x04)
	float LPFRadiusMin; // 0xcc(0x04)
	float LPFRadiusMax; // 0xd0(0x04)
	...
	float LPFFrequencyAtMin; // 0x1e8(0x04)
	float LPFFrequencyAtMax; // 0x1ec(0x04)
	float HPFFrequencyAtMin; // 0x1f0(0x04)
	float HPFFrequencyAtMax; // 0x1f4(0x04)
	float FocusAzimuth; // 0x1f8(0x04)
	float NonFocusAzimuth; // 0x1fc(0x04)
	float FocusDistanceScale; // 0x200(0x04)
	float NonFocusDistanceScale; // 0x204(0x04)
	float FocusPriorityScale; // 0x208(0x04)
	float NonFocusPriorityScale; // 0x20c(0x04)
	float FocusVolumeAttenuation; // 0x210(0x04)
	float NonFocusVolumeAttenuation; // 0x214(0x04)
	float FocusAttackInterpSpeed; // 0x218(0x04)
	float FocusReleaseInterpSpeed; // 0x21c(0x04)
	float OcclusionLowPassFilterFrequency; // 0x220(0x04)
	float OcclusionVolumeAttenuation; // 0x224(0x04)
	float OcclusionInterpolationTime; // 0x228(0x04)
	float ReverbWetLevelMin; // 0x22c(0x04)
	float ReverbWetLevelMax; // 0x230(0x04)
	float ReverbDistanceMin; // 0x234(0x04)
	float ReverbDistanceMax; // 0x238(0x04)
	float ManualReverbSendLevel; // 0x23c(0x04)
	struct FRuntimeFloatCurve CustomReverbSendCurve; // 0x240(0x88)
	struct TArray<struct FAttenuationSubmixSendSettings> SubmixSendSettings; // 0x2c8(0x10)
	float PriorityAttenuationMin; // 0x2d8(0x04)
	float PriorityAttenuationMax; // 0x2dc(0x04)
	float PriorityAttenuationDistanceMin; // 0x2e0(0x04)
	float PriorityAttenuationDistanceMax; // 0x2e4(0x04)
	float ManualPriorityAttenuation; // 0x2e8(0x04)
	char pad_2EC[0x4]; // 0x2ec(0x04)
	struct FRuntimeFloatCurve CustomPriorityAttenuationCurve; // 0x2f0(0x88)
	struct FSoundAttenuationPluginSettings PluginSettings; // 0x378(0x30)
};
