...
struct ABGA_CurieFireMesh_MolotovCocktail_C : ABGA_GenericCurieFuel_Parent_C {
	...
	void UserConstructionScript(); // Function BGA_CurieFireMesh_MolotovCocktail.BGA_CurieFireMesh_MolotovCocktail_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0xda7c34
};
