...
struct FGameplayCuePendingExecute {
	char pad_0[0x18]; // 0x00(0x18)
	struct FPredictionKey PredictionKey; // 0x18(0x10)
	enum class EGameplayCuePayloadType PayloadType; // 0x28(0x01)
	char pad_29[0x7]; // 0x29(0x07)
	struct UAbilitySystemComponent* OwningComponent; // 0x30(0x08)
	struct FGameplayEffectSpecForRPC FromSpec; // 0x38(0x78)
	struct FGameplayCueParameters CueParameters; // 0xb0(0xc0)
};

// ScriptStruct GameplayAbilities.MinimalGameplayCueReplicationProxy
// Size: 0x290 (Inherited: 0x00)
struct FMinimalGameplayCueReplicationProxy {
	char pad_0[0x280]; // 0x00(0x280)
	struct UAbilitySystemComponent* Owner; // 0x280(0x08)
...
struct FMovieSceneGameplayCueKey {
	...
	struct FName AttachSocketName; // 0x20(0x08)
	float NormalizedMagnitude; // 0x28(0x04)
	struct FMovieSceneObjectBindingID Instigator; // 0x2c(0x18)
	struct FMovieSceneObjectBindingID EffectCauser; // 0x44(0x18)
	char pad_5C[0x4]; // 0x5c(0x04)
	struct UPhysicalMaterial* PhysicalMaterial; // 0x60(0x08)
	int32_t GameplayEffectLevel; // 0x68(0x04)
	int32_t AbilityLevel; // 0x6c(0x04)
	bool bAttachToBinding; // 0x70(0x01)
