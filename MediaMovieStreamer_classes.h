...
struct UMediaMovieAssets : UObject {
	...
	struct UMediaTexture* MediaTexture; // 0x38(0x08)
	char pad_40[0x8]; // 0x40(0x08)

	void OnMediaEnd(); // Function MediaMovieStreamer.MediaMovieAssets.OnMediaEnd // (Final|Native|Private) // @ game+0x3ff5388
};
